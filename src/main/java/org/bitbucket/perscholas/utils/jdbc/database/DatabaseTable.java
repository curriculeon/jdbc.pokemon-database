...
import org.bitbucket.perscholas.utils.jdbc.resultset.ResultExtractor;
...
public class DatabaseTable {
    ...
    public <PersistentType> void create(Class<PersistentType> persistentType) {
        DatabaseTableStatementGenerator<PersistentType> statementGenerator = new DatabaseTableStatementGenerator<>(database, persistentType);
        String createStatement = statementGenerator.getCreateStatement();
        executor.executeQuery(createStatement);
    }
